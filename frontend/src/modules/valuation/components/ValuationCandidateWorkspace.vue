      ...
      >
        <div class="candidate-card__heading">
          <div>
            ...
            <code class="candidate-card__field-code">{{ candidate.form_code }}.{{ candidate.field_name }}</code>
        ...
        <label class="candidate-card__value">
          <small v-if="candidate.field_guidance" class="candidate-card__guidance">主要填寫：{{ candidate.field_guidance }}</small>
          ...
          <input
            ...
            :type="candidateInputType(candidate)"
            :inputmode="candidateInputMode(candidate)"
            :placeholder="`請填寫：${candidate.field_label || fieldDisplayLabel(candidate.form_code, candidate.field_name)}`"
