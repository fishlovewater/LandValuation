...
TEMPLATE_FACTORS = (
    ...
    TemplateFactor("restricted_building", "LAND_USE_CONTROL", "有無限制建築", 641),
    ...
    TemplateFactor("road_plan", "TRANSPORT", "區段內道路規劃及開闢程度", 546),
    TemplateFactor("drainage", "NATURAL", "排水之良否", 524),
    TemplateFactor("terrain", "NATURAL", "地勢", 511),
    TemplateFactor("market_proximity", "PUBLIC_FACILITY", "接近市場之程度", 484),
    TemplateFactor("park_proximity", "PUBLIC_FACILITY", "接近公園之程度", 469),
    ...
    TemplateFactor("power_gas_facility", "SPECIAL_FACILITY", "電業設施及公用氣體燃料設施", 419),
    TemplateFactor("funeral_facility", "SPECIAL_FACILITY", "殮葬設施之有無及接近程度", 402),
    TemplateFactor("waste_facility", "SPECIAL_FACILITY", "廢棄物處理設施之有無及接近程度", 389),
    TemplateFactor("environmental_pollution", "POLLUTION", "水、噪音、廢氣及廢棄物污染", 361),
    ...
    TemplateFactor("exhibition_hotel", "COMMERCIAL_ACTIVITY", "大型展示中心或觀光飯店之接近程度", 283),
    TemplateFactor("pedestrian_flow", "COMMERCIAL_ACTIVITY", "顧客通行量之多寡", 264),
    TemplateFactor("vacancy_rate", "COMMERCIAL_ACTIVITY", "店舖之歇業狀態", 251),
